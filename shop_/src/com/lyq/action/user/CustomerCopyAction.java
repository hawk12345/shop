 ...
 */
@Scope("prototype")
@Controller("CustomerCopyAction")
public class CustomerCopyAction extends BaseAction implements ModelDriven<Customer>{
	...
	public String save() throws Exception{
		...
		String usernameString = ""+request.get("username");
